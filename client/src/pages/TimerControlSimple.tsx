...
export const TimerControlSimple: React.FC = () => {
  const { 
    timerState, 
    currentPhase,
    mainButtonLabel,
      ...
      <div className="app-content">
        ...
        <Card variant="compact" className="section-spacing">
          <div className="grid-status">
            ...
            <div>
              ...
              <div className="timer-display-large">
                {timerState?.isRunning || timerState?.currentTime ? timerState?.totalRounds : "—"}
              </div>
            </div>
          </div>
        ...
        <div className="grid-config section-spacing">
          <Card>
            ...
            <Stepper
              value={config.rounds}
              onValueChange={(value) => updateConfig({ ...config, rounds: value })}
              min={TIMER_CONSTANTS.LIMITS.MIN_ROUNDS}
              max={TIMER_CONSTANTS.LIMITS.MAX_ROUNDS}
              step={1}
              size="large"
              variant="minimal"
              showValue={true}
            ...
            <TimeInput
              ...
              onValueChange={(value) => updateConfig({ ...config, fightTime: value })}
              label="Fight Time"
              minMinutes={0}
              maxMinutes={60}
              minSeconds={0}
            ...
            <TimeInput
              ...
              onValueChange={(value) => updateConfig({ ...config, restTime: value })}
              label="Rest Time"
              minMinutes={0}
              maxMinutes={10}
              minSeconds={0}
          ...
          <Card>
            ...
            <Button
              onClick={() => window.open('/tv-simple', '_blank')}
              variant="secondary"
              size="large"
              icon={<Monitor />}
              fullWidth
